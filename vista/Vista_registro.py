from PyQt5.QtWidgets import QMainWindow, QWidget, QVBoxLayout, QLabel, QLineEdit, QPushButton, QMessageBox, QDesktopWidget
...
class Vista_registro(QMainWindow):
    ...
    def __init__(self):
        ...
        self.label.setStyleSheet("font-size: 48px; font-weight: bold;")  # Estilo del texto (mucho más grande)
...
if __name__ == "__main__":
    ...
    # Conectar botones a funciones de prueba
    register_view.register_button.clicked.connect(lambda: print("Registrarse presionado"))
    register_view.login_button.clicked.connect(lambda: print("Iniciar Sesión presionado"))
